import { Goal, Achievement } from '@prisma/client';

export const calculateScore = (goal: Partial<Goal>, achievement: Partial<Achievement> | undefined): number | null => {
  ...
  if (goal.baseline !== undefined && goal.baseline !== null) {
